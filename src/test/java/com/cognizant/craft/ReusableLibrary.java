...
/*/
	 ...
	 **/
	public void waitUntilElementVisible(WebElement element, int timeOutInSeconds) {
...
/*	 * Function to wait until the specified element is enabled
	 ...
	 * @param timeOutInSeconds The wait timeout in seconds
	 */
	public void waitUntilElementEnabled(WebElement element, long timeOutInSeconds) {
		(new WebDriverWait(driver.getWebDriver(), timeOutInSeconds))
	...
	public void WebDriverWait(WebDriver driver,WebElement element,int timeout){
